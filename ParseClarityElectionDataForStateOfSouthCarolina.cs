...
namespace ParseClarityElectionDataForStateOfSouthCarolina
{
	...
	class Program
	{
		static string ProjectName = "ParseClarityElectionDataForStateOfSouthCarolina";

		static string LocationBeingStudied = "StateOfSouthCarolina";

		static string LocationBeingStudiedClearly = "State Of South Carolina";

		static string gitHubRepositoryURL = "https://github.com/IneffablePerformativity/" + ProjectName;

		static string gitHubRepositoryShortened = "https://bit.ly/2VmkIgC";
...
//		static bool discardStraightPartyVotes = true; // affects bonus, csv, more than plot
		...
		static bool useConceptOfStraightPartyVotes = true; // only affects messages
...
//		static int howOrdering = 8; // 8 is net bonus
		...
		const string contestStraight1 = "STRAIGHT PARTY 1";
		const string contestStraight2 = "STRAIGHT PARTY 2";
		const string contestStraight3 = "STRAIGHT PARTY 3";
		...
		const string contestPotus = "President and Vice President";

		
		// zero, one, or two
		const string contestSenus1 = "U.S. Senate";
		...
		const string contestRepus1 = "U.S.  House of Representatives, District  1";
		const string contestRepus2 = "U.S.  House of Representatives, District  2";
		const string contestRepus3 = "U.S.  House of Representatives, District  3";
		const string contestRepus4 = "U.S.  House of Representatives, District  4";
		const string contestRepus5 = "U.S.  House of Representatives, District  5";
		const string contestRepus6 = "U.S.  House of Representatives, District  6";
		const string contestRepus7 = "U.S.  House of Representatives, District  7";
		...
		static void inputDetailXmlFile()
		{
			...
			foreach(XmlNode xnContest in xnlContests)
			{
				...
				switch(contest)
				{
					...
					case contestStraight2:
					case contestStraight3:
